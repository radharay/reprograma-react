  ...
  render(){
    return (
      <main className="conta">
        ...
        <Campo ref={this.nomeRef} id="nome"type="nome"name="nome"placeholder="Nome"  required
        minLength={10} onChange={this.habilitaOuDesabilita} />
        ...
        minLength={6} onChange={this.habilitaOuDesabilita}/>
